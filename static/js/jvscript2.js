...
(function () {
	...
	$(function () {
		...
		if (plugins.typedjs.length && !isNoviBuilder) {
			...
			var e = ["The road to your company's success", "We make your dreams a reality", "Simple solutions for complex connections", "Pushing limits", "Committed to people, committed to the future"];
			$('.typed-text').typed({
				strings:   e,
				typeSpeed: 150,
				loop:      !0,
				...
				$form.attr('novalidate', 'novalidate').ajaxForm({
					...
					success:      function (result) {
						...
						if (result === "MF000") {
							...
							if (output.hasClass("snackbars")) {
								output.html(' <p class="snackbars-left"><span class="icon icon-xxs mdi check text-middle"></span><span>' + msg[result] + '</span></p>');
							} else {
